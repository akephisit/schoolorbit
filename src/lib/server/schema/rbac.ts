...
export const rolePermission = pgTable('role_permission', {
  ...
  rolePermUnique: uniqueIndex('role_permission_role_perm_unique').on(t.roleId, t.permissionId)
}));
...
export const userRole = pgTable('user_role', {
  ...
  userRoleUnique: uniqueIndex('user_role_user_role_unique').on(t.userId, t.roleId)
}));
